...
import {  PlayersData } from '../../infrastructure'
import usePlayersColumns from '../../Hooks/usePlayerColumn';

const PlayerGrid = ({ rows }) => {
        ...
        <Grid item xs={12}>
          <Card>
            ...
            <CardContent>
              ...
              <CustomDataGrid columns={columns}  sx={gridStyles.root} rows={PlayersData(DataUser)}  />
            </CardContent>
          </Card>
        </Grid>
      </Grid>
